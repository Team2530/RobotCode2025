...
@Logged
public class CoralElevatorOld extends SubsystemBase {
        ...
        public CoralElevatorOld() {
                ...
                leaderConfig.encoder
                                ...
                                .velocityConversionFactor(60.0 / Elevator.MOTOR_REVOLUTIONS_PER_METER); // Multiply by
                                                                                                        // 60/RpM to get
                                                                                                        // m/s
        ...
        public void simulationPeriodic() {
                // update physics
                simElevator
                                .setInput(MathUtil.clamp(simLeaderMotor.getAppliedOutput() * RoboRioSim.getVInVoltage(),
                                                -12.0, 12.0));
