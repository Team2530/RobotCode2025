...
public final class Constants {
  ...
  public static class DriveConstants {
    ...
    public static final double GLOBAL_kA = 0.15; // V/(m/ss)
  ...
  public static class Coral {
    ...
    public static class Pitch {
      ...
      public static final ArmFeedforward FEEDFORWARD = new ArmFeedforward(0.050, 0.21, 0.44, 0.005);
  ...
  public static final class Algae {
    ...
    public static final class Intake {
      ...
      public static final double HOLDING_THRESHOLD = Units.inchesToMeters(5.5);
  ...
  public static final class AutoConstants {
    ...
    public static final double ALGAE_BARGE_SCORE_WAIT = 0.5;
  }
