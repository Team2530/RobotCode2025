...
public final class Constants {
  ...
  public static final class PoseConstants {
    ...
    public static final Pose2d[] blueCoralScores = { // IN METERS AND DEGREES
      new Pose2d(new Translation2d(), new Rotation2d(Units.degreesToRadians(90))), // A
      new Pose2d(new Translation2d(), new Rotation2d(Units.degreesToRadians(90))), // B
      ...
      new Pose2d(new Translation2d(), new Rotation2d(Units.degreesToRadians(-150))), // E
      new Pose2d(new Translation2d(5.49, 3.05), new Rotation2d(Units.degreesToRadians(-150))), // F
      new Pose2d(new Translation2d(), new Rotation2d(Units.degreesToRadians(-90))), // G
      new Pose2d(new Translation2d(), new Rotation2d(Units.degreesToRadians(-90))), // H
      new Pose2d(new Translation2d(), new Rotation2d(Units.degreesToRadians(-30))), // I
      new Pose2d(new Translation2d(), new Rotation2d(Units.degreesToRadians(-30))), // J
      new Pose2d(new Translation2d(), new Rotation2d(Units.degreesToRadians(30))), // K
      new Pose2d(new Translation2d(), new Rotation2d(Units.degreesToRadians(30))), // L
    };
