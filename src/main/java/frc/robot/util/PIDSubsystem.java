//? Copied from ProfiledPID Subsystem as it is marked for removal, so making a refrence class to be used to remove warning
...
public abstract class PIDSubsystem extends SubsystemBase {
   ...
   */
  public PIDSubsystem(ProfiledPIDController controller, double initialPosition) {
   ...
   * @param controller the ProfiledPIDController to use
   */
  public PIDSubsystem(ProfiledPIDController controller) {
    this(controller, 0);
  }
